...
public class GMapV2Direction {
    ...
    private Document doc, temp;

    public GMapV2Direction() {
        handler = new Handler();
    }

    public Document getDocument(final LatLng start, final LatLng end, String mode) {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    url = new URL("http://maps.googleapis.com/maps/api/directions/xml?origin="
                                + String.valueOf(start.latitude) + "," + String.valueOf(start.longitude) + "&destination="
